...
# Argument over whether to use selenium or beautifulsoup to parse HTML. Perhaps selenium is basic but gets the job done and using it only simplifies things. beautifulsoup may be for more advanced parsing I am not aware of yet.
...
default_env_globals = {
    'driver_path':r'D:/Development/noteScrape/geckodriver',
    'save_dir_path':r'D:/Development/noteScrape/notes/',
}
...
def selenium_scrape(dashboard_url, base_url, driver_path, save_dir_path):
    ...
    for task_url in urls:
        ...
        print('-'*20)
        # proper debug messages / options needed

    # let user do the timing when calling the function / program
